  ...
  Map<String, dynamic> _userToJson(UserEntity user) {
    return {
      ...
      'stats': {
        ...
        'completedBarters': user.stats.completedBarters,
  ...
  UserEntity _userFromJson(Map<String, dynamic> json) {
    return UserEntity(
      ...
      stats: UserStats(
        ...
        completedBarters: json['stats']['completedBarters'],
        rating: (json['stats']['rating'] ?? 0).toDouble(),
        reviewCount: json['stats']['reviewCount'],
